...
# ╔═╡ a82fe0ad-c4a5-453a-8243-e1691a1677ef
begin
	using JLD2
	BACGH = jldopen("../BACGH.jld2", "r")
	CGA = BACGH["cgh"]
	CGK = keys(CGA)
end
...
# ╔═╡ e10ba11d-01dc-4c74-9c36-6b899ef981e4
@bind CGF Slider(1:length(CGK), default=1684, show_value=true)

# ╔═╡ cfaa3187-7537-4188-99e1-65648e9e33ad
6600/30
...
# ╔═╡ eb74ed96-f08d-490f-a648-f915ba3e491d
# ╠═╡ disabled = true
# ╠═╡ skip_as_script = true
#=╠═╡
while true
	for i in 1:12:length(CGK)
		k = CGK[i]
		send_image(openfinch, Gray.(CGA[k]))
	end
end
  ╠═╡ =#

# ╔═╡ 0eb5ab3c-fcdf-4562-95dd-487905b8b135
# ╠═╡ disabled = true
# ╠═╡ skip_as_script = true
#=╠═╡
send_image(openfinch, Gray.(CGA[CGK[CGF]]))
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "3e9ac1782fdbfb217b4c2ed532ca6840d6c3e599"
