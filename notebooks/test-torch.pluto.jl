...
# ╔═╡ 5d0e350c-2f51-11ef-0a9d-7577aad8cbeb
begin
	using Images
	using TestImages
...
# ╔═╡ 0c5692ae-537b-4885-85cc-a8fd85d111b6
torch

# ╔═╡ 61af3423-6ff6-4086-922e-5186ef10d40f
...
# ╔═╡ eaf4672f-00d1-4a7f-8990-1c59518d7d66
...
# ╔═╡ cadb23f7-05f1-4380-a0db-11881e3c89ac
...
# ╔═╡ 12ba8c7d-43f7-4527-91ee-e769330bd254
...
# ╔═╡ e46ecc14-23ab-4bfb-bdb5-a3d4f0da6ab2
# ╠═╡ skip_as_script = true
#=╠═╡
@benchmark begin
	out = torch.fft.ifft(torch.mul(torch.fft.fft2(ts), tk))
...
# ╔═╡ ed2ea28f-675e-4317-85d3-b816439d905c
out = torch.fft.ifft(torch.mul(torch.fft.fft2(ts), tk))

# ╔═╡ 37843eb8-69d3-49ec-ade0-88af04e62c92
@benchmark out.cpu().numpy()

# ╔═╡ 267b68b1-dfd1-478f-95df-5acd3a76d9e1
...
manifest_format = "2.0"
project_hash = "fb4dceaef77acd8d43e2b64d3386456049805ee3"
