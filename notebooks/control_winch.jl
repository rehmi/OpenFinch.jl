...
# ╔═╡ 719eb709-d50e-4481-aff1-565815b55f6b
begin
	using PlutoUI
...
# ╔═╡ ed93a095-99b6-437f-a8e8-4454398006eb
md"""
# CGH by incoherent photon sampling
"""

# ╔═╡ d02636fe-61ec-4a8b-a5ab-79d5b8f5d710
begin
	md"""
...
# ╔═╡ 0724741c-0eb7-469e-8573-014921138a04
enable_TOC ? TableOfContents() : nothing

# ╔═╡ a9d92e4c-4906-4412-9c82-250e7fae0102
begin
	host = "winch.local"
	port = 8000
	URI = "ws://$host:$port/ws"
...
# ╔═╡ 6b79d459-b5af-4059-9a49-78b18019eab9


# ╔═╡ 17cfe3fb-0bbe-4025-a603-6b6e522634df
begin
...
# ╔═╡ 76e8d6ef-2506-4a05-9cd2-f2ee7ee2e8dd
md"""
...
# ╔═╡ 1dcfab62-ff38-49c4-b6ef-d1d037f41e2f
md"""
---
# Definitions
"""

# ╔═╡ f79d3347-c1e6-448a-8777-59433bef8196
begin
...
# ╔═╡ dc49dc62-52bc-4652-b487-35c5341832fb
openfinch = OpenFinchConnection(URI)

# ╔═╡ bb089bd7-21e3-4539-a87b-253eedb18d17
begin
...
# ╔═╡ b9d0658f-1d90-44fa-96db-918bbf60748c
...
# ╔═╡ c87e43d3-bc78-4b51-8743-934298c41d80
dashboard_html = """
<!DOCTYPE html>
<html>
...
# ╔═╡ 1b07b8b2-8353-480a-bcf0-05e745cf6ea1
HTML("""
<html><body><script> 
var host = "$host";
var port = "$port";
...
# ╔═╡ 5014e18f-f84f-4ae8-9ee2-34619a059ef6
md"""
## Persistent websocket API (experimental)
"""

# ╔═╡ 133eee28-11e1-4e7b-88e8-08f214902330
...
# ╔═╡ 2f2b863c-780b-48f2-8be8-be3f88de7c3c
# ╠═╡ skip_as_script = true
#=╠═╡
ws = rawws(URI);
  ╠═╡ =#

# ╔═╡ bffbef88-5152-4668-aefe-6d4ceeae2c0c
#=╠═╡
...
# ╔═╡ 25faab59-881a-4151-b8e7-0e8919eec6a5
#=╠═╡
ws
  ╠═╡ =#

# ╔═╡ ddd652f4-6d91-4fa2-99ca-fa47cad6663e
# ╠═╡ skip_as_script = true
#=╠═╡
...
manifest_format = "2.0"
project_hash = "e8c53b0c8dde52262dd9d2500cc7b02575cff3e5"
...
git-tree-sha1 = "9d0df474ca2c6e4acdc7ef83df512009864672d6"
